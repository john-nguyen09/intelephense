...
class NamespaceUseClauseCompletion {
    ...
    canSuggest(traverser) {
        ...
        return traverser.ancestor(this._isNamespaceUseClause) !== undefined ||
            (parsedDocument_1.ParsedDocument.isPhrase(traverser.parent(), [121 /* NamespaceName */]) &&
                parsedDocument_1.ParsedDocument.isPhrase(traverser.parent(), [124 /* NamespaceUseDeclaration */]));
    }
    completions(traverser, word) {
        let items = [];
